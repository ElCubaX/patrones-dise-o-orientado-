...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(" Historia Usuario: Como gerente de planta, quiero poder calcular el costo total de producción de un lote de acero, para poder planificar el presupuesto.");
